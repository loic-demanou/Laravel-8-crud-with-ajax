                   ...
                   <input type="hidden" name="book_id" id="book_id">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            @error('title') is-invalid @enderror name="title" value="{{ old('title') }}" maxlength="50" required="">
                        </div>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea id="author" name="author" required="" placeholder="Enter Author" class="form-control"
                            @error('author') is-invalid @enderror name="author" value="{{ old('author') }}"></textarea>
                        </div>
                        @error('author')
                        <span class="help-block" role="alert">
                            <strong>{{ $message }}</strong>
